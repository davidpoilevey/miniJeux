...
export const randomGenome = (nbChromosomes=NUM_CHROMOSOMES) => {
  NUM_CHROMOSOMES = nbChromosomes;
  const chromosomes = new Array(nbChromosomes);
  for (let i = 0; i < nbChromosomes; i++) {
